...
export default async function AdminPosterViewPage() {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-heading font-bold mb-2">Poster Dashboard (Admin View)</h1>
            <p className="text-xl text-white/60">
              Viewing the platform as a task poster
            </p>
          </div>
